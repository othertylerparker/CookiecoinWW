...
uint256 hashGenesisBlock("0xe6253786d3565ed2664b5f834374b1b8ff9e7d5a078f1e5f9747fbea11b50315");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000); // Cookiecoin: 10k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Cookiecoin: 1 day
static const int64 nTargetSpacing = 5 * 60; // Cookiecoin: 5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4b47538b52f792130ed489336265a477b95f7cca97d7139199bde355d7e2db85");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "CookiecoinWW - I create the coin at 15/01/2018";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0433d91e8433e3c0a8d7b3280fe48d8f103dd3a6aacd75d6803dd42921f6098f3dec0ae2132e2824be7d949638d7643dbd01557503751c3e06ce97dc5721deac49") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1516045573;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086370541;

        if (fTestNet)
        {
            block.nTime    = 1516045773;
            block.nNonce   = 386852969;
        }
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x83fc672655f90b7b4a41dc6c2125e914f5aeeb9be0f2c1c2536f7433d6f208ca"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xba, 0xd3 }; // Cookiecoin: increase each by adding 2 to bitcoin's value.
